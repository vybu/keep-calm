...
export const FacebookIcon = ({href}) => (
    <a href={href} target="_blank" className="SocialIcon">
...
export const GoogleplusIcon = ({href}) => (
    <a href={href} target="_blank" className="SocialIcon SocialIcon-googlePlus">
...
export const PinterestIcon = ({href}) => (
    <a href={href} target="_blank" className="SocialIcon">
