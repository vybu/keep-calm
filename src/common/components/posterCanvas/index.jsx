        ...
        return (
            <Stage width={width} height={height}>
                <Layer ref="toImg">
                    ...
                    <TextLine maxWidth={width} text={text[1]} x={width / 2} y={t3.y} fontSize={t3.fontSize}/>
                    <TextLine maxWidth={width} text={text[2]} x={width / 2} y={t4.y} fontSize={t4.fontSize}/>
                    <TextLine maxWidth={width} text={text[3]} x={width / 2} y={t5.y} fontSize={t5.fontSize}/>
                    <TextLine maxWidth={width} text={text[4]} x={width / 2} y={t6.y} fontSize={t6.fontSize}/>
                </Layer>
            </Stage>
        );
    }
